 ...
 */
class OnClickItemTermListener(private val overlapHeight: Int = 0,
        ...
        when (event.action and MotionEvent.ACTION_MASK) {
            ...
            MotionEvent.ACTION_CANCEL, MotionEvent.ACTION_UP -> if (mIsClicked) {
                ...
                if (firstVisibleItemPosition == 0) {
                    val firstViewHolder = rv.findViewHolderForAdapterPosition(firstVisibleItemPosition)
                ...
                if (lastVisibleItemPosition == adapter.itemCount - 1) {
                    val lastItemViewHolder = rv.findViewHolderForAdapterPosition(lastVisibleItemPosition)
                ...
                for (position in firstVisibleItemPosition until lastVisibleItemPosition) {
                    ...
                    if (aboveViewHolderBottomY != null && aboveViewHolderHeight != null
                        ...
                        val startY = aboveViewHolderBottomY - getOverlapHeight(aboveViewHolderHeight)
